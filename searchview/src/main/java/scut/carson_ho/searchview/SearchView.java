...
public class SearchView extends LinearLayout {
    ...
    private ImageButton seathbutton;
    // ListView列表 & 适配器
    ...
    private void init(){
        ...
        seathbutton.setOnClickListener(new OnClickListener() {
            /*** @param v
             */
            @Override
            public void onClick(View v) {
    ...
    private void initView(){
        ...
        seathbutton= (ImageButton) findViewById(R.id.seathbutton);
     ...
     * 点击键盘中搜索键后的操作，用于接口回调
     */
    public void setOnClickSearchButton(SearchButton searchButton){
